...
```bash
python3 tools/pm/board.py forecast                 # every epic
python3 tools/pm/board.py forecast --epic <id>     # one epic
python3 tools/pm/board.py report --json            # the same numbers, for your own reasoning
```
