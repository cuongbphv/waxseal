...
Bằng chứng: [`tests/test_cli_pin.py`](../../tests/test_cli_pin.py), lớp
`TestDeclareViaCLI` - các test CLI chạy `main()` thật, đọc lại file pin state, và assert
JSON khớp đúng format
